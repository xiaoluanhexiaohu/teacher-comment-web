...
export function TemplateEditor({ defaultValue, onSubmit }: { defaultValue?: { title?: string; content?: string }; onSubmit: (v: { title: string; content: string }) => void }): React.JSX.Element {
